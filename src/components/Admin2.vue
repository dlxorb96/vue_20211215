<template>
    <div>
        ...
        <!-- <menu-1  v-if="this.menu ===1"/>
        <menu-2  v-else-if="this.menu ===2"/>
        <menu-3  v-else-if="this.menu ===3"/>
        <menu-4  v-else-if="this.menu ===4"/>
        <hr /> -->
        <div>
        ...
        <!-- <div> -->
            ...
            <input type="button" value="컴포넌트삭제" @click="handleComp(3)"> -->
        <!-- </div> -->
    </div>
</template>
